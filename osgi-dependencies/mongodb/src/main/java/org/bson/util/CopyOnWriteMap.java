 ...
 * implementations </p>
 *
 * <p>There are supplied implementations for the common j.u.c {@link Map} implementations via the {@link CopyOnWriteMap} static
 * {@link Builder}. </p>
 *
...
abstract class CopyOnWriteMap<K, V> extends AbstractCopyOnWriteMap<K, V, Map<K, V>> {
    ...
    /**
     * <p>Creates a new {@link CopyOnWriteMap} with an underlying {@link LinkedHashMap}. Iterators for this map will be return
    ...
    /**
     * <p>Creates a new {@link CopyOnWriteMap} with an underlying {@link LinkedHashMap} using the supplied map as the initial
