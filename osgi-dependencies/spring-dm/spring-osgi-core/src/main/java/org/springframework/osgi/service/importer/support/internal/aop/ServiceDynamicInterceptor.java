...
public class ServiceDynamicInterceptor extends ServiceInvoker implements InitializingBean, ApplicationEventPublisherAware {
    ...
    private final RefreshableSupplier<Object> serviceLocator = new MemoizingSupplier<Object>(new Supplier<Object>() {
        @Override
        public Object get() {
    ...
    public void afterPropertiesSet() {
        ...
        if (serviceRequiredAtStartup) {
            ...
            PUBLIC_LOGGER.info("Looking for mandatory OSGi service dependency for bean [" + sourceName + "] matching filter " + filter);
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof ServiceDynamicInterceptor) {
            ...
            return (serviceRequiredAtStartup == oth.serviceRequiredAtStartup && ObjectUtils.nullSafeEquals(wrapper, oth.wrapper)
                        && ObjectUtils.nullSafeEquals(filter, oth.filter) && ObjectUtils.nullSafeEquals(retryTemplate, oth.retryTemplate));
        } else
            return false;
    }
    ...
    static class MemoizingSupplier<T> implements RefreshableSupplier<T>, Serializable {
