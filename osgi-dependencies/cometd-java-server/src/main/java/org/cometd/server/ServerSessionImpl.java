...
public class ServerSessionImpl implements ServerSession {
    ...
    private final AtomicReference<SessionState> sessionState = new AtomicReference<SessionState>(UNINITILIZED);
    ...
    public boolean isConnected() {
        return isConnected(sessionState.get());
    }
    ...
    public boolean isDisconnected() {
        return sessionState.get() == SessionState.DISCONNECTED;
    }
    ...
    @Override
    public String toString() {
        return String.format("%s - last connect %d ms ago", _id, now() - _connectTimestamp);
    }
