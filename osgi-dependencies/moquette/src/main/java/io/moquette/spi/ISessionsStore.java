...
public interface ISessionsStore {
    ...
    void register(String clientID, ClientSessionListener clientSessionListener);

    void unregister(String clientID, ClientSessionListener listener);

    Iterable<ClientSessionListener> sessionListenersFor(String clientID);
}
